...
creaPieDePagina = function(){
	var m = '<p align="center" class="azul1" >Subsecretaría de Educación Básica,';
	m += 'Viaducto Río Piedad 507, 4o piso. Granjas México,';
	m +=' Iztacalco 08400. México D.F.</p>';
	var n = document.getElementById('pieDePagina');
	n.innerHTML = m;
}