package {
	...
	public class Tooltip extends Sprite {
		...
		public static const DISABLE:Number = -1;
		...
		private function make_body( body:String ):TextField {
			...
			fmt2.font = "Verdana";
			//fmt2.font = "spArial"; //Chaning All the Fonts to Arial
		...
		public function hide_quick():void {
			this.tip_showing = false;
			//tr.ace('hide tooltip quick');
			this.hideAway();
		}			
