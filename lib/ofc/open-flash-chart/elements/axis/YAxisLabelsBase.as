package elements.axis {
	...
	public class YAxisLabelsBase extends Sprite {
		...
		private function replace_magic_values(labelText:String, yVal:Number):String {
			...
			// Start Change
			// added by Etw based on patch in http://forums.openflashchart.com/viewtopic.php?f=19&t=2078 by dlindquist
			labelText = labelText.replace('#humansize#', NumberUtils.formatSize(yVal));
			labelText = labelText.replace('#humantime#', NumberUtils.formatTime(yVal));
			// End Change
			return labelText;
		}
	}
